...
//               <li key={index} className="nav-item" style={{paddingLeft:'15px',paddingRight:"15px"}} role="presentation">
//                 <button
//                   className={`nav-link spaceLandR ${activeTab === date ? "active" : ""}`}
//                   onClick={() => {
      ...
      <div className="container my-5 p-5">
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          <div className="container-fluid">
            <p className="navbar-brand" style={{fontSize:"15px"}} >
                Click on the date
            </p>
            <button
