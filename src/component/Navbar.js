...
//           </div>
//           <button className="navbar-toggler homenavbarbutton" type="btn" data-bs-toggle="collapse" data-bs-target="#T" aria-controls="T" aria-expanded={!navClose ? true : false} aria-label="Toggle navigation" onClick={handleNavClose}>
...
function Navbar(){
  ...
  useEffect(() => {
    function handleResize() {
      setNavClose(window.innerWidth > 991 ? false : true);
    }
